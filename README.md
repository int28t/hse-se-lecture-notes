...
| **C++** | `bonus-materials`, `colloquium` | Файлы к коллоквиуму |
| **Discret Math** | `seminar notes` | *Сырые* конспекты семинаров |
| **Economics** | `cheatsheet`, `seminars` | *Сырые* конспекты и шпаргалка к КР по экономике |

### 2 Курс (2026—2027) _[TBA]_
