...
\subsubsection{Доказательство от противного}
...
\subsubsection{Достаточность и необходимость}
\begin{figure}[h]
  \centering
...
\subsection{Комбинаторика и Бином Ньютона}
...
\subsection{Основные понятия и предел последовательности}
