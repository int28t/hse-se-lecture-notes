...
Не будем рассматривать тривиальные случаи $q = 0;1;-1$

{\bf (1) $q>1$}, $\Lim{n}{\infty } a_n = +\infty $

\[
    \forall M > 0\ \exists N(M)\ \forall n > N(M)\ a_n > M
\]
\[
    q^n > M
\]

Используем неравенство Бернулли $(q - 1 > 0)$
\[
    (1 + (q - 1))^n > M
\]
\[
...
Предъявим номер
\[
N(M)=\l|\left[ \frac{M-1}{q - 1} \right]\r| + 1
\]

{\bf (2) $0<q<1$}, $\Lim{n}{\infty } a_n = 0 $

\[
    q^n = \left( \frac{1}{1/q} \right)^n = \frac{1}{(1/q)^n}, \frac{1}{q} > 1
\]

$(1/q)^n$ --- б.б, тогда $\frac{1}{(1/q)^n}$ --- б.м

{\bf (3) $-1<q<0$}, $\Lim{n}{\infty } a_n = 0 $

\[
    q^n = (-1)^n (|q|)^n, |q| \in (0;1)
\]
Последовательность $(-1)^n$ ограничена, а $|q|^n$ — бесконечно малая.  
Следовательно, $q^n \to 0$

{\bf (4) $q<-1$} $\Lim{n}{\infty } a_n = \infty  $
...
{\bf (1) $a>1$}, $\Lim{n}{\infty } \sqrt[n]{a} = 1 $

\[
    \forall \eps > 0\ \exists N(\eps )\ \forall n > N(\eps )\ |\sqrt[n]{a} - 1| < \eps 
\]
\[
    \sqrt[n]{a} - 1 < \varepsilon
\]
\[
    \sqrt[n]{a} < \varepsilon + 1
\]
\[
    a < (\eps + 1)^n
\]
...
\]
\[
    N(\varepsilon) = \left[ \frac{a-1}{\varepsilon} \right] + 1
\]

{\bf (2) $0 < a < 1$}, $\Lim{n}{\infty } \sqrt[n]{a} = 1$
\[
    \sqrt[n]{a} = \frac{1}{\sqrt[n]{1/a}},\qquad \frac{1}{a}>1
\]
\[
    \sqrt[n]{1/a} \xrightarrow[n\to\infty]{} 1
\]
\[
    \frac{1}{1} \xrightarrow[n\to \infty ]{} 1
\]
...
Хотим $\Lim{n}{\infty } \sqrt[n]{n} = 1$

\[
    \forall \eps > 0\ \exists N(\eps )\ \forall n > N(\eps )\ |\sqrt[n]{n} - 1| < \eps 
\]
\[
    |\sqrt[n]{n} - 1| < \eps 
\]
...
По биному Ньютона:
\[
    (1+\varepsilon)^n = \sum_{k=0}^n \binom{n}{k}\varepsilon^k > \binom{n}{2}\varepsilon^2
\]
\[
    n < \binom{n}{2}\eps ^2
\]
\[
    n < \frac{n(n - 1)}{2} \eps^2
\]
\[
    1 < \frac{n - 1}{2} \eps^2
\]
...
\[
    0 < \frac{n^2}{(1 + 1)^n} < \frac{n^2}{\binom{n}{3}} = \frac{n^2}{\frac{n(n-1)(n-2)}{3!}} \xrightarrow[n \to \infty ]{} 0
\]
Получаем
\[
    \frac{n^2}{2^n} \xrightarrow[n \to \infty ]{} 0
\]
Обобщение: 
\[
    \frac{n^k}{a^n}, a > 1 \xrightarrow[n \to \infty ]{} 0
\]
Потому что всегда можно сделать оценку с помощью бинома в знаменателе.

Вывод: показательная функция растет быстрее степенной
...
\begin{Proof}
\[
    \frac{2^n}{n!} = \prod_{k=1}^n \frac{2}{k} = \frac{2}{1}\cdot\frac{2}{2}\cdot\frac{2}{3}\cdot \ldots \cdot\frac{2}{n}
\]
По теореме о зажатой последовательности
\[
    0 < \frac{2^n}{n!} \leq \frac{2}{n} \cdot 2 \xrightarrow[n \to \infty ]{} 0
\]
Вывод: факториал растет быстрее любой показательной
